...
Ens han demanat que els ajudem a modernitzar-se en 4 coses:
...
* P01. Proposta tècnica i dossier de desplegament per a FoodLogístic S.A.  
* P02. Web corporativa legal i publicada del client.  
* P03. Repositori de Github
...
Després de parlar amb el client i mirar com funcionen, hem vist que tenen 4 problemes principals:
...
Què ens ha demanat exactament el client? (T01)  
L'encàrrec de FoodLogístic té 4 àrees obligatòries  
\-Configurar un servidor de fitxers en alta disponibilitat perquè els transportistes i administratius accedeixin sempre als albarans

\-Configurar un servidor d'impressió en alta disponibilitat perquè les etiquetes s'imprimeixin sense parar al magatzem

\-Fer el salt al núvol amb un servei de correu que tingui calendari, xat i videotrucades

\-Fer el salt al núvol amb un servei de correu que tingui calendari, xat i videotrucades

\-Proposar una pàgina web nova que compleixi la llei (avís legal, cookies, privacitat)

Què hem vist de la competència? (T01)

Hem mirat 3 empreses de Mataró QUE FAN EL MATEIX :

Informàtic Mataró	Petita	Reparacions , manteniment  
Sisticat Mitjana Hosting , servidors,  correu  
JSM Consultoria Mitjana, Manteniment, cloud, seguretat
...
[marcjurado983.github.io/web-corporativa/](https://marcjurado983.github.io/web-corporativa/)
...
Solució cloud triada: Microsoft 365 Business Standard
